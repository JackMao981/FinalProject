...
class Characteristics:
    ...
    def damage_output(self):
        ...
        """
        return self.atk, self.true_damage
    ...
    def damage_taken(self, input_damage):
        ...
        if (self.armor > damage):
            ...
            self.armor = 0
            return true_damage + damage - self.armor
...
class Item:
    def __init__(self, modifiers, name):
        ...
        self.name = name
class Potion(Item):
    def __init__(self, modifiers = {"health":1}, name = "Doran's Shield"):
        """
...
class Shield(Item):
    def __init__(self, modifiers = {"armor": 1}, name = "Doran's Shield"):
        """
        creates Doran_shield, an item that modifies max_health and armor
        Doran shield be initialized by its default values only
        modifiers: dictionary, stores the attributes of the item
...
class Heart(Item):
    def __init__(self, modifiers = {"max_health": 1}, name = "Doran's Shield"):
        """
        creates Doran_shield, an item that modifies max_health and armor
        Doran shield be initialized by its default values only
        modifiers: dictionary, stores the attributes of the item
